...
public class AdvancedCraftErrorScreen
    extends AESubScreen<AdvancedCraftConfirmMenu, AdvancedCraftConfirmScreen> {
  public AdvancedCraftErrorScreen(
      AdvancedCraftConfirmScreen parent, CraftingSubmitErrorCode errorCode, Object details) {
        ...
        switch (errorCode) {
          ...
          case MISSING_INGREDIENT -> {
            if (details instanceof GenericStack genericStack) {
              addClientSideSlot(
                  new ClientDisplaySlot(genericStack), SlotSemantics.MISSING_INGREDIENT);
            }
