...
public class MirrorAdvPatternProviderLogic extends AdvPatternProviderLogic
  ...
  public MirrorAdvPatternProviderLogic(
      IManagedGridNode mainNode,
      AdvPatternProviderLogicHost host,
      int patternInventorySize,
      Class<? extends AdvPatternProviderLogicHost> targetPartClass,
      Class<? extends AdvPatternProviderLogicHost> targetBeClass) {
  ...
  public Optional<AdvPatternProviderLogic> getSource() {
    ...
    if (sourceLogic == null && be != null && targetBeClass == be.getClass()) {
      sourceLogic = ((AdvPatternProviderLogicHost) be).getLogic();
    }
  ...
  public void updateSource(IGridNode node) {
    if (node != null) {
      ...
      if (owner.getClass() == targetPartClass || owner.getClass() == targetBeClass) {
        syncFromSource(((AdvPatternProviderLogicHost) owner).getLogic());
        return;
      }
    }
  ...
  public InternalInventory getPatternInv() {
    return this.getSource()
        .map(AdvPatternProviderLogic::getPatternInv)
        .orElse(super.getPatternInv());
  }

  public void syncFromSource(AdvPatternProviderLogic source) {
    IMixinPatternProviderLogic thisMixin = (IMixinPatternProviderLogic) this;
    ...
    if (thisMixin instanceof IMixinAdvPatternProviderLogic advThisMixin
        && sourceMixin instanceof IMixinAdvPatternProviderLogic advSourceMixin) {
      advThisMixin.AAE$setOutputCache(advSourceMixin.AAE$getOutputCache());
    }
  ...
  private void clearLocalCache() {
    ...
    if (thisMixin instanceof IMixinAdvPatternProviderLogic advThisMixin) {
      advThisMixin.AAE$setOutputCache(new HashSet<>());
    }
