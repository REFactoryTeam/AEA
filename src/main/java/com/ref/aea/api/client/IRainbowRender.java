...
public interface IRainbowRender {
  ...
  Map<Direction, AABB> FACE_BOXES =
      BoxHelper.createRotatedBoxes(new AABB(0, 0, 15 / 16.0, 1, 1, 1).inflate(0.002D));

  Map<Direction, AABB> FACE_CONNECTION_BOXES =
      BoxHelper.createRotatedBoxes(
          new AABB(3 / 16.0, 3 / 16.0, 14 / 16.0, 13 / 16.0, 13 / 16.0, 16 / 16.0).inflate(0.002D));
  ...
  void drawWorldRainbowLine(Vec3 v1, Vec3 v2, RenderLevelStageEvent event);
